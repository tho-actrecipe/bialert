...
// AWS region in which to deploy the BiAlert components.
...
// If using BiAlert to scan existing S3 buckets, add the S3 and KMS resource ARNs here to grant
