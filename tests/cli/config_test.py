...
from cli.config import BiAlertConfig, CONFIG_FILE
...
class BiAlertConfigTestFakeFilesystem(FakeFilesystemBase):
    """Tests of the BiAlertConfig class that use a fake filesystem."""
    ...
    @mock.patch.object(BiAlertConfig, '_encrypt_cb_api_token')
