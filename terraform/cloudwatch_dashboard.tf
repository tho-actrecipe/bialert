// CloudWatch dashboard for BiAlert
  ...
  s3_bucket_stats = <<EOF
{
  ...
  "height": 3,
  "properties": {
    "title": "S3: ${aws_s3_bucket.BiAlert_binaries.id}",
    ...
    "metrics": [
      [
        ...
        "BucketName", "${aws_s3_bucket.BiAlert_binaries.id}",
  ...
  yara_rules = <<EOF
{
  ...
  "properties": {
    ...
    "view": "singleValue",
    "metrics": [
      ["BiAlert", "YaraRules", {"label": "YARA Rules"}]
    ]
  }
}
EOF
...
EOF
  ...
  downloader_function_name = module.BiAlert_downloader.function_name
  ...
  "properties": {
    ...
    "metrics": [
      [
        ...
        "FunctionName", "${module.BiAlert_analyzer.function_name}",
        {"label": "Analyzer"}
      ]
...
s3_download_latency = <<EOF
{
  ...
  "properties": {
    ...
    "region": "${var.aws_region}",
    "metrics": [
      ["BiAlert", "S3DownloadLatency", {"label": "Minimum", "stat": "Minimum"}],
  ...
  "properties": {
    ...
    "metrics": [
      [
        ...
        "LogGroupName", "${module.BiAlert_analyzer.log_group_name}",
        {"label": "Analyzer"}
      ]
...
resource "aws_cloudwatch_dashboard" "BiAlert" {
  dashboard_name = "BiAlert"
